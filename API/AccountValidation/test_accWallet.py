...
class TestAccountWallet:
    ...
    def url(self):
        ...
        razPay1 = requests.get("https://api.razorpay.com/v1/settlements",
                               params={"from":1696636800,"to":1696723200},
        ...
        data = {"pagination": {"limit": 100},
                "filters": {"start_date": "2023-10-07T18:30:00+05:30",
                            "end_date": "2023-10-08T18:30:00+05:30"}}  # start date = previous date, end date = current date
