...
class TestAccountWallet:
    ...
    def url(self):
        ...
        razPay1 = requests.get("https://api.razorpay.com/v1/settlements",
                               params={"from": f"{previousDateFUnix}", "to": f"{currentDateFUnix}"},
        ...
        data = {"pagination": {"limit": 100},
                "filters": {"start_date": f"{previousDateStr}T18:30:00+05:30",
                            "end_date": f"{currentDateStr}T18:30:00+05:30"}}  # start date = previous date, end date = current date
    ...
    def test_getTallyAccountWalletRazor1(self,url):
        ...
        # ICICI BANK - 753
        amtReceivedInRaz1ICICI753Name = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][1][
            "name"]
        amtReceivedInRaz1ICICI753Debit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][1][
            "debit"]
        amtReceivedInRaz1ICICI753Credit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][1][
            "credit"]
        ...
        # RBL BANK
        amtReceivedInRaz1RBLBankName = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][2]["name"]
        amtReceivedInRaz1RBLBankDebit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][2]["debit"]
        amtReceivedInRaz1RBLBankCredit = walletSettlAPIResp.json()["data"]["titles"][0]["subtitles"][4]["section"][2]["credit"]
    ...
    def test_getTallyAccountWalletRazor2(self,url):
        ...
        # #ICICI BANK - 30400
        amtReceivedInRaz2ICICI30400Name = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][0]["name"]
        amtReceivedInRaz2ICICI30400Debit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][0]["debit"]
        amtReceivedInRaz2ICICI30400Credit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][0]["credit"]
        #
        ...
        # #ICICI BANK - 753
        amtReceivedInRaz2ICICI753Name = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][1]["name"]
        amtReceivedInRaz2ICICI753Debit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][1]["debit"]
        amtReceivedInRaz2ICICI753Credit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][1]["credit"]
        ...
        # #RBL BANK
        amtReceivedInRaz2RBLBankName = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][2]["name"]
        amtReceivedInRaz2RBLBankDebit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][2]["debit"]
        amtReceivedInRaz2RBLBankCredit = walletSettlAPIResp.json()["data"]["titles"][1]["subtitles"][4]["section"][2]["credit"]
