...
class TestRepayment:
    def test_getRepayment(self):
        ...
        responseAllLoanID = requests.get(
            "https://lendittfinserve.com/prod/admin/transaction/allRepaidLoans?start_date=2023-10-30T10:00:00.000Z&end_date=2023-10-30T10:00:00.000Z&page=1&pagesize=10&getTotal=true&download=true",
        ...
        for i in lIDs:
            ...
            totalPaidAmountT = round(math.ceil(sum(tPaidAmount)))
            print("totalPaidAmountInTran::", totalAmountToBePaidForm)
            diffOfTotalPaidAmtEAndPaidAmtTran = sum(totalPaidAmountE) - totalPaidAmountT
