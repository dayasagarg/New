...
print("CurrentFullTime::",CurrentFullTime)
...
class TestMissedLIDInRepayment:
    ...
    def url(self):
        ...
        response2 = requests.get(
            f"https://lendittfinserve.com/prod/admin/emi/repaymentStatus?fromDate={CurrentDate}T10:00:00.000Z&endDate={CurrentDate}T10:00:00.000Z&type=TOTAL&page=1&download=true",
            verify=False)  # current date
