        ...
        try:
            ...
            try:
                if loanEndDate2 in firstPage:
                    print(
                        f" *** 'loanEndDate2' :'{loanEndDate2}' is matched with LOAN DETAILS in first Page of pdf *** ")
                else:
                    print(
                        f"Exception :: 'loanEndDate2' :'{loanEndDate2}' is not matched with LOAN DETAILS in first Page of pdf ")
                ...
                if loanEndDate3 in firstPage:
                    print(f" *** 'loanEndDate3' :'{loanEndDate3}' is matched with LOAN DETAILS in first Page of pdf *** ")
                else:
                    print(f"Error :: 'loanEndDate3' :'{loanEndDate3}' is not matched with LOAN DETAILS in first Page of pdf ")
